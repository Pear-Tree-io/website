...
export default function Page() {
    return (
        <main>
            ...
            <Image style={{margin-top: '10px', width: '270px'}} src={gameLogo} alt="Game Logo" />
            <Link style={{margin-bottom: '10px'}} href="https://play.google.com/store/apps/details?id=com.PearTree.CountSheap">
